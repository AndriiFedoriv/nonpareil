class ProductList {
  ...
  addEventListeners() {
    ...
    document
      .getElementById('sort-by-price-increase')
      .addEventListener('click', () => this.sortByPriceIncrease());
    document
      .getElementById('sort-by-price-decrease')
      .addEventListener('click', () => this.sortByPriceDecrease());
    document
      .getElementById('sort-by-popularity')
      .addEventListener('click', () => this.sortByPopularity());
    document
      .getElementById('sort-by-name-increase')
      .addEventListener('click', () => this.sortByNameIncrease());
    document
      .getElementById('sort-by-name-decrease')
      .addEventListener('click', () => this.sortByNameDecrease());
    document
      .getElementById('Apple')
      .addEventListener('click', () => this.sortByBrandApple());
    document
      .getElementById('Samsung')
      .addEventListener('click', () => this.sortByBrandSamsung());
    document
      .getElementById('Xiaomi')
      .addEventListener('click', () => this.sortByBrandXiaomi());
    document
      .getElementById('Realme')
      .addEventListener('click', () => this.sortByBrandRealme());
    document
      .getElementById('Huawei')
      .addEventListener('click', () => this.sortByBrandHuawei());
    document
      .getElementById('Meizu')
      .addEventListener('click', () => this.sortByBrandMeizu());
    document
      .getElementById('all-brands')
      .addEventListener('click', () => this.sortByBrandAll());
  }
